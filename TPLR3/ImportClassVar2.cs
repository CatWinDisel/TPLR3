...
{
    public void ImportThreeFloatColumnsByName(
        string filePath,
        string columnName1, string columnName2, string columnName3, out List<DateTime> list1, out List<float> list2, out List<float> list3)
    {
